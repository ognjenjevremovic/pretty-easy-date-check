...
function dateString() {
    describe('Date String', function () {
        ...
        validate_1.validDateValue_returnsTrue(info, '03,04,2017');
        validate_1.validDateValue_returnsTrue(info, '03 04 2017');
        validate_1.validDateValue_returnsTrue(info, '03.04.17.');
        validate_1.validDateValue_returnsTrue(info, '03/04/17');
        validate_1.validDateValue_returnsTrue(info, '03-04-17');
        validate_1.validDateValue_returnsTrue(info, '03,04,17');
        validate_1.validDateValue_returnsTrue(info, '03 04 17');
        ...
        validate_1.validDateValue_returnsTrue(info, 'Mon Mar 20 17');
        validate_1.validDateValue_returnsTrue(info, 'Mon Mar 20 17 15:38:55');
